...
const productos = [
 ...
 //RELACIÓN DE CATEGORIA CON POST
 //UNA CATEGORIA TIENE MUCHOS POST
 Categoria.hasMany(Post);
//POST PERTENECE A UNA CATEGORIA
 Post.belongsTo(Categoria);

 //RELECION DE POST CON USUARIO
 //usuario tiene muchos post
 Usuario.hasMany(Post);
 //los post pertenecen a un usuario
 ...
 //relacon de usuario con comentario
 Usuario.hasMany(Comentario);
 Comentario.belongsTo(Usuario);

 //relacion entre like_dislike hacia post
Post.hasMany(LikeDislike);
LikeDislike.belongsTo(Post);

//relacion estre like_dislike y usuario
Usuario.hasMany(LikeDislike);
LikeDislike.belongsTo(Usuario);
